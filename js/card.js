...
window.PCARD = (function () {
  ...
  async function drawAnimal(c){
    ...
    x.fillStyle=C.muted; x.font=sans(400,22); x.fillText("the Primal Oracle", W/2, 1292);
    return cv;
  }
  ...
  return {
    ...
    async shareAnimal(c){ const cv=await drawAnimal(c); return share(cv,"primal-"+slug(c.primal)+".png","My Primal Animal is the "+c.primal+". Find yours at the Primal Oracle."); },
